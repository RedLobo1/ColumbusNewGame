...
public class DanceMinigameController : MonoBehaviour
{
    // ─── Inspector Variables ───────────────────────────────────────────────────
    ...
    [Header("Dancer Sprites")]
    public Sprite dancer1Neutral;
    ...
    public GameObject watchIndicator;  // "WATCH" image — shown during demo
    public GameObject danceIndicator;  // "DANCE" image — shown during player input

    [Header("Difficulty / Timing")]
    [Tooltip("Base number of moves in a combo at difficulty 1")]
